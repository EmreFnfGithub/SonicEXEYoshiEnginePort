...
function create() {
    ...
    if (note.isSustainNote) {
        if (note.prevNote != null)
            if (note.prevNote.animation.curAnim.name == "laugh")
                note.prevNote.animation.play("laugh");
        note.animation.play("laugh");
        else
        {
                 if (note.prevNote.animation.curAnim.name == "singDOWN")
                note.prevNote.animation.play("laugh");
        note.animation.play("laugh");
        }
    }
